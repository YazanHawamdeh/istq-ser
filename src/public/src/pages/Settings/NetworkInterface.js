...
export default function NetWrokInterface() {
  const [state, setState] = useState({});

  const [showDelete, setShowDelete] = useState(null);

  const { NETWORK_INTERFACE } = useSelector((state) => state.LOOKUPS_STORE);
      ...
      <div className="page-content">
        <Container fluid>
          <Row className="mb-2">
            ...
            <Create type={LookupsEnums.NETWORK_INTERFACE} />
          </Row>
        </Container>
